    ...
    .container.mx-auto.px-5.lg_px-32
      ...
      section.flex.h-screen
        .m-auto.w-full
          ...
          //- nav links
          ul.flex.mt-6
            li(v-for="(link, i) in data.links" data-aos="fade-up" :data-aos-delay="String((i+1) * 300)")
      ...
      section.pt-16#projects
        ...
        section.mt-12(v-for="project in data.projects" data-aos="fade-up")
        ...
        section.mt-12(data-aos="fade-up")
        ...
        section
          .flex.flex-wrap.-mx-4
            div.px-4.mt-12(v-for="game in data.games" class="w-full lg_w-1/2")
              h3.text-3xl(data-aos="fade-up") {{ game.title }}
              p.mb-4(data-aos="fade-up")
                template(v-for="(link, index) in game.links")
                  ...
                  template(v-if="index < game.links.length - 1")
                    ...
                    | /
                    |
              section.flex.bg-gray-100.p-2.sm_p-4.game-image-wrapper(data-aos="fade-up")
                .m-auto
      ...
      section.pt-16.mt-32#talks
        ...
        //- Nuxt talk
        section.mt-10(v-for="talk in data.talks" data-aos="fade-up")
      ...
      section.pt-16.mt-32#about
        h2.text-3xl.sm_text-4xl.font-bold.leading-tight.anchor-work(data-aos="fade-up") I've been working in the IT industry for almost six years.
        ...
        section.companies-section.mt-10
          .company(
            ...
            h3.text-xl.sm_text-2xl.leading-tight(data-aos="fade-right" data-aos-anchor=".anchor-work" :data-aos-delay="String((i*300)+100)") {{ company.position }}
            p.text-gray-600(data-aos="fade-right" data-aos-anchor=".anchor-work" :data-aos-delay="String((i*300)+200)") {{ company.name }}
            p.text-gray-600(data-aos="fade-right" data-aos-anchor=".anchor-work" :data-aos-delay="String((i*300)+300)") {{ company.period }}
      ...
      section.mt-40
        ...
        template(v-for="(skills, skillCategoryIdx) in data.skills")
          h3.text-2xl.mt-8(data-aos="fade-up" data-aos-offset="150" :class="`anchor-skill-${skillCategoryIdx}`") {{ skills.name }}
          ul.text-gray-600.leading-6
            li(
              v-for="(skill, subSkillIdx) in skills.skills"
              data-aos="fade-right"
              data-aos-offset="150"
              :data-aos-delay="String(100 + (subSkillIdx * 50))"
